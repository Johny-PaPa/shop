        ...
        <div className='wrapper'>
            <section className='section-header'>
                    ...
                    < div className="container">
                        <ul className="sawe">
                            <h1 className="big">ENDER MAPLE FINGERBOARD</h1>
                            <h2 className="momo">Главная/Каталог/Электрогитара/FENDER MAPLE FINGERBOARD</h2>
                            <div className="cls">
                                <div className="rars">
                                    <img className="cat_ob_con" src={El2_1} />
                                    <div className="arww">
