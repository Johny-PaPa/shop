        ...
        <div className='wrapper'>
            <section className='section-header'>
                    ...
                    < div className="container">
                        <ul className="sawe">
                            <h1 className="big">FENDER CC-60S SUNBURST</h1>
                            <h2 className="momo">Главная/Каталог/Акустическая гитара/FENDER CC-60S SUNBURST</h2>
                            <div className="cls">
                                <div className="rars">
                                    <img className="cat_ob_con" src={Ak1_2} />
                                    <div className="arww">
                                        <h1 className="centr1">25 200 Р</h1>
